...
def print_header():
    ...
    header = """
MPS-SENDER - SMS Sender with Twilio and Nexmo API
...
def check_balance_twilio(client):
    """Placeholder function to check balance (Twilio does not provide a direct API for balance)."""
    return None
...
def display_account_info_twilio(client):
    """Display the Twilio phone numbers associated with the account."""
    print("[INFO]: Fetching sender phone numbers...")
    try:
        incoming_numbers = client.incoming_phone_numbers.list()
        if incoming_numbers:
            print("[INFO]: Your Twilio phone numbers:")
            for number in incoming_numbers:
                print(f"    {number.phone_number}")
        else:
            print("[INFO]: No Twilio phone numbers found.")
    except TwilioException as e:
        print(f"[ERROR]: Failed to fetch Twilio phone numbers: {e}")
